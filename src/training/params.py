...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Sample 2000 from roco_test to eval",
    )
    parser.add_argument(
        "--resume-model-only",
        default=False,
        action="store_true",
        help="Resume no state other than model weights",
    )

    ######################################################################################
    # HACK For communication only, don't specity the following params
    parser.add_argument(
        "--clip-model",
        type=str,
        default=None,
